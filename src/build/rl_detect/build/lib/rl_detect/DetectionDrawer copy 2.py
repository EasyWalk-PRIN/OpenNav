...
class DetectionDrawer():
    ...
    def __call__(self, image,masks, depth_image, boxes, scores, class_ids, mask_alpha=0.3):
        return self.draw_detections(image,masks,depth_image, boxes, scores, class_ids, mask_alpha)
    ...
    def draw_detections(self, image,masks, depth_image, boxes, scores, class_ids, mask_alpha=0.3):
